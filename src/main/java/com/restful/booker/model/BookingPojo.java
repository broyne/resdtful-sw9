...
public class BookingPojo {
    ...
    public static BookingPojo getBookingPojo(String fName, String lName, int totalPrice, boolean depositPaid, HashMap<String, String> bookingDates, String additionalNeeds) {
